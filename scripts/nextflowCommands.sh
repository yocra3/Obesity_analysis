...
--gwas_vcf_file results/postImputation/merged/2021-04-26/ObesityGWAS.imputatedArrays.mergedDataset.filtered.vcf.gz \
--plink_prefix results/postImputation/merged/2021-04-26/ObesityGWAS.imputatedArrays.mergedDataset.filtered \
--cohortTable data/inputAssociation.tsv \
--pcs_file results/postImputation/stats/2021-04-26/mergedDataset.filtered.eigenvec -profile docker -resume
